        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-12">
          <div>
            ...
            <p className="text-gray-600 mb-8">
              Vous avez des questions sur nos produits? Vous souhaitez en savoir plus sur SmartFit? N'hésitez pas à nous contacter, notre équipe se fera un plaisir de vous répondre.
            </p>
